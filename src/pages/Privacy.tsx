    ...
    <>
      ...
      <div className="max-w-3xl mx-auto bg-gray-900 rounded-2xl p-8 shadow-sm border border-gray-800">
        ...
        <div className="prose prose-invert prose-green max-w-none text-gray-300 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-gray-100 mt-8 mb-4">1. جمع المعلومات</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-100 mt-8 mb-4">2. ملفات تعريف الارتباط (Cookies)</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-100 mt-8 mb-4">3. إعلانات Google AdSense</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-100 mt-8 mb-4">4. أمن البيانات</h2>
          <p>
            نحن نتخذ إجراءات أمنية مناسبة لحماية بياناتك من الوصول غير المصرح به أو التعديل أو الإفصاح أو الإتلاف.
          </p>

          <h2 className="text-xl font-bold text-gray-100 mt-8 mb-4">5. التغييرات على سياسة الخصوصية</h2>
          <p>
