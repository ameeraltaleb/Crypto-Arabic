...
export default function Market() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-12 relative transition-colors duration-300">
      <Helmet>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] opacity-10 dark:opacity-20" style={{ background: 'radial-gradient(circle, rgba(243,186,47,0.15) 0%, rgba(0,0,0,0) 70%)' }}></div>
      </div>

      <div className="max-w-7xl mx-auto px-4 relative z-10">
        
        {/* Header Section */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm p-5 md:p-8 rounded-[2rem] border border-gray-200 dark:border-gray-800/60 shadow-2xl transition-colors duration-300">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-yellow-500/10 p-3 rounded-xl">
                <Activity className="w-8 h-8 text-yellow-600 dark:text-yellow-500" />
              </div>
              <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white">أسعار السوق والتحليل الفني</h1>
            </div>
          ...
          <div className="flex flex-col items-end gap-3">
            <div className="flex items-center gap-2 text-sm font-medium bg-gray-100 dark:bg-gray-950/50 px-4 py-2 rounded-full border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        ...
        <section className="mb-16">
          <div className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm rounded-[2.5rem] border border-gray-200 dark:border-gray-800/60 shadow-2xl overflow-hidden p-1 transition-colors duration-300">
            <div className="p-6 border-b border-gray-200 dark:border-gray-800/60 flex items-center justify-between">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-400 font-mono bg-gray-100 dark:bg-gray-950 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-800 transition-colors duration-300">
                {selectedCoin}
              </div>
            </div>
        ...
        <div className="hidden md:block bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm rounded-[2rem] border border-gray-200 dark:border-gray-800/60 shadow-2xl overflow-hidden transition-colors duration-300">
          <div className="overflow-x-auto">
            <table className="w-full text-right border-collapse">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-950/50 border-b border-gray-200 dark:border-gray-800/60 text-gray-500 dark:text-gray-400 text-sm transition-colors duration-300">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-800/40 transition-colors duration-300">
                {loading ? (
                  Array.from({ length: 10 }).map((_, i) => (
                    <tr key={i} className="animate-pulse">
                      <td className="p-5"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-4 mx-auto"></div></td>
                      <td className="p-5"><div className="flex items-center gap-3"><div className="w-8 h-8 bg-gray-200 dark:bg-gray-800 rounded-full"></div><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-24"></div></div></td>
                      <td className="p-5"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-20"></div></td>
                      <td className="p-5"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-16"></div></td>
                      <td className="p-5"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-16"></div></td>
                      <td className="p-5"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-16"></div></td>
                      <td className="p-5 hidden md:table-cell"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-24"></div></td>
                      <td className="p-5 hidden lg:table-cell"><div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-24"></div></td>
                      <td className="p-5"><div className="h-8 bg-gray-200 dark:bg-gray-800 rounded-lg w-16 mx-auto"></div></td>
                    </tr>
                  ))
                ) : (
                  coins.map((coin) => (
                    <tr 
                      key={coin.id} 
                      className={`hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group cursor-pointer ${selectedCoin.includes(coin.symbol.toUpperCase()) ? 'bg-yellow-50 dark:bg-yellow-500/5' : ''}`}
                    ...
                    >
                      ...
                      <td className="p-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            <span className="font-bold text-gray-900 dark:text-gray-100">{coin.name}</span>
                            <span className="text-xs text-gray-500 uppercase font-medium">{coin.symbol}</span>
                          </div>
                        </div>
                      </td>
                      <td className="p-5 font-bold text-gray-900 dark:text-white tracking-wide">
                        {formatCurrency(coin.current_price)}
                      </td>
                      <td className="p-5 font-medium">
                        <div className={`flex items-center justify-end gap-1 ${
                          (coin.price_change_percentage_1h_in_currency || 0) >= 0 ? 'text-green-600 dark:text-green-500' : 'text-red-600 dark:text-red-500'
                        }`}>
                      ...
                      <td className="p-5 font-bold">
                        <div className={`flex items-center justify-end gap-1 ${
                          coin.price_change_percentage_24h >= 0 ? 'text-green-600 dark:text-green-500' : 'text-red-600 dark:text-red-500'
                        }`}>
                      ...
                      <td className="p-5 font-medium">
                        <div className={`flex items-center justify-end gap-1 ${
                          (coin.price_change_percentage_7d_in_currency || 0) >= 0 ? 'text-green-600 dark:text-green-500' : 'text-red-600 dark:text-red-500'
                        }`}>
                      ...
                      <td className="p-5 text-gray-600 dark:text-gray-300 font-medium hidden md:table-cell tracking-wide">
                        {formatCurrency(coin.total_volume)}
                      </td>
                      <td className="p-5 text-gray-600 dark:text-gray-300 font-medium hidden lg:table-cell tracking-wide">
        ...
        <div className="md:hidden flex flex-col gap-4">
          {loading ? (
            Array.from({ length: 10 }).map((_, i) => (
              <div key={i} className="bg-white/40 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800/60 rounded-2xl p-5 animate-pulse transition-colors duration-300">
            ...
            coins.map((coin) => (
              <div 
                key={coin.id} 
                className={`bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm border border-gray-200 dark:border-gray-800/60 rounded-2xl p-5 shadow-lg transition-all duration-300 ${selectedCoin.includes(coin.symbol.toUpperCase()) ? 'border-yellow-500/50 bg-yellow-50 dark:bg-yellow-500/5' : ''}`}
                onClick={() => setSelectedCoin(`BINANCE:${coin.symbol.toUpperCase()}USDT`)}
              >
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold text-gray-900 dark:text-gray-100 text-sm">{coin.name}</span>
                      <span className="text-xs text-gray-500 uppercase">{coin.symbol}</span>
                    </div>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="font-bold text-gray-900 dark:text-white tracking-wide">{formatCurrency(coin.current_price)}</span>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-800/40 transition-colors duration-300">
                  <div>
        ...
        <div className="mt-16">
          ...
          {loadingArticles ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map(i => (
                <div key={i} className="animate-pulse bg-white/50 dark:bg-gray-900/50 rounded-2xl h-[300px] border border-gray-200 dark:border-gray-800/60 transition-colors duration-300"></div>
              ))}
            </div>
          ) : articles.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {articles.map((article) => (
                <Link 
                  ...
                  className="group bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800/60 hover:border-yellow-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-yellow-500/10 flex flex-col"
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    <div className="text-yellow-600 dark:text-yellow-500 text-xs font-bold mb-2">
