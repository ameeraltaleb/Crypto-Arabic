  ...
  return (
    <>
      ...
      <header className="mb-10">
        ...
        {/* Social Share */}
        <div className="flex items-center gap-4 py-6 border-y border-gray-800/60">
          ...
          <a 
            ...
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#1DA1F2] hover:border-[#1DA1F2] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#0088cc] hover:border-[#0088cc] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#25D366] hover:border-[#25D366] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#4267B2] hover:border-[#4267B2] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg"
          ...
          <button 
            onClick={copyLink}
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-green-600 hover:border-green-600 text-gray-300 hover:text-white rounded-xl transition-all relative shadow-lg"
            title="نسخ الرابط"
          >
