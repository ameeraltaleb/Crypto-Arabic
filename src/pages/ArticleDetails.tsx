    ...
    <>
      ...
      <header className="mb-10">
        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400 mb-6">
          <span className="bg-green-500/10 text-green-500 px-4 py-1.5 rounded-full font-bold border border-green-500/20">
        ...
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-100 leading-[1.3] mb-6">
          {article.title}
        </h1>

        <p className="text-xl text-gray-300 leading-relaxed mb-8 border-r-4 border-green-500 pr-5 py-2 bg-gradient-to-l from-green-500/5 to-transparent rounded-l-xl">
          {article.summary}
        </p>

        {article.image_url && (
          <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-8 border border-gray-800/60">
            <img 
        ...
        {/* Social Share */}
        <div className="grid grid-cols-5 sm:flex sm:items-center gap-3 sm:gap-4 py-6 border-y border-gray-800/60">
          <span className="col-span-5 sm:col-span-1 text-gray-400 font-bold flex items-center gap-2 mb-2 sm:mb-0">
          ...
          <a 
            ...
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#1DA1F2] hover:border-[#1DA1F2] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg flex items-center justify-center"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#0088cc] hover:border-[#0088cc] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg flex items-center justify-center"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#25D366] hover:border-[#25D366] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg flex items-center justify-center"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-[#4267B2] hover:border-[#4267B2] text-gray-300 hover:text-white rounded-xl transition-all shadow-lg flex items-center justify-center"
          ...
          <button 
            onClick={copyLink}
            className="p-3 bg-gray-900 border border-gray-800 hover:bg-green-600 hover:border-green-600 text-gray-300 hover:text-white rounded-xl transition-all relative shadow-lg flex items-center justify-center"
            title="نسخ الرابط"
          >
            <LinkIcon className="w-5 h-5" />
            {copied && (
              <span className="absolute -top-10 left-1/2 -translate-x-1/2 bg-green-500 text-white text-xs py-1.5 px-3 rounded-lg font-bold shadow-lg whitespace-nowrap">
                تم النسخ!
              </span>
            )}
          </button>
      ...
      {article.source_url && (
        <div className="mt-12 pt-8 border-t border-gray-800/60">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-green-500 text-sm bg-gray-900/50 px-4 py-2 rounded-xl border border-gray-800/60 transition-colors"
          >
      ...
      {relatedArticles.length > 0 && (
        <section className="mt-16 pt-12 border-t border-gray-800/60">
