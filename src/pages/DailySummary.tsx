    ...
    <div className="min-h-screen bg-gray-950 py-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        <div className="bg-gray-900/40 backdrop-blur-xl rounded-[2.5rem] border border-gray-800/60 shadow-2xl overflow-hidden min-h-[400px]">
          ...
          <div className="p-6 bg-gray-950/50 border-t border-gray-800/60 flex items-center justify-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          ...
          <div className="bg-gray-900/40 backdrop-blur-sm p-6 rounded-3xl border border-gray-800/60 hover:border-green-500/30 transition-colors group">
            ...
            <h3 className="text-white font-bold mb-2">مجتمعنا</h3>
            <p className="text-gray-400 text-sm">انضم لقناتنا على تيليجرام لتصلك أهم التنبيهات والفرص الاستثمارية.</p>
          </div>
        </div>
      </div>
    </div>
